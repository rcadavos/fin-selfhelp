...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "improvement", description: "'Recently paid' is now ordered by when you paid, newest first, instead of by due date — so the bill you just marked paid is always the top row, and each one sinks as you pay the next." },
      { type: "improvement", description: "Pop-ups and slide-up forms on phones now have noticeably rounder top corners, so a sheet reads as a card lifting off the bottom edge rather than a panel butting into the screen." },
