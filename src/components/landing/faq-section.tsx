...
const faqs: { q: string; a: string }[] = [
  {
    q: "What is OmniTrak?",
    a: "A personal finance hub focused on bills and cashflow: track expenses by category, mark what you paid each month, manage goals, set reminders, and use calculators — tuned for everyday use in the Philippines.",
  },
  {
  ...
  },
  {
    ...
    a: "With Pro or Premium (active on your account), you can invite someone by email and choose what they may view—your Bills and/or your Reminders. They sign in with their own OmniTrak account and get the access you grant; they cannot change your bill amounts.",
  },
  {
  ...
  },
  {
    ...
    a: "All plans can attach due dates to bills. With Pro or Premium (and an active subscription), you can also enable email reminder windows for each bill. Reminders are sent by email according to the options you pick. The free plan does not include email reminders.",
  },
  {
