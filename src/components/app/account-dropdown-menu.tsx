...
export function AccountDropdownMenu({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side={side} align={align} className="w-60 overflow-hidden p-0">
        ...
        <div className="p-1">
          <DropdownMenuItem asChild className="min-h-10 px-2.5 text-sm [&_svg]:size-4">
          ...
          <DropdownMenuItem
            className="flex min-h-10 cursor-pointer items-center gap-2.5 px-2.5 text-sm [&_svg]:size-4"
            onSelect={(e) => {
              e.preventDefault();
