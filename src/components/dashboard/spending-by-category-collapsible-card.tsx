  ...
  return (
    <Card className={cn("h-full", dashed && "border-dashed bg-muted/20")}>
      <CardHeader className="space-y-0 border-0 p-0 pb-0 sm:p-6 sm:pb-0 sm:pt-4">
        <button
          type="button"
          className="surface-t flex w-full items-center justify-between gap-2 px-6 py-4 text-left transition-colors hover:bg-muted/40 active:bg-muted/50 sm:hidden"
          onClick={onToggle}
