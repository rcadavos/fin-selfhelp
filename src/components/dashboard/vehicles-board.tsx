...
const CATEGORY_BARS = [
  { key: "fuel",        label: "Fuel",                  color: "hsl(var(--primary))" },
  { key: "fees",        label: "Fees",                  color: "hsl(var(--primary) / 0.78)" },
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex-shrink-0 rounded-full p-1 text-muted-foreground/40 transition-colors hover:bg-destructive/10 hover:text-destructive"
        title="Delete"
      >
