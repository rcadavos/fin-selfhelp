    ...
    <div className="container mx-auto max-w-2xl px-4 py-6">
      <div className="mb-6 flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Preferences and notification choices for this device.</p>
        </div>
      </div>
      ...
      <Card className="mb-6 border-primary/20">
        ...
        <CardContent>
          <Button variant="outline" asChild>
            <Link href="/settings/sharing">Manage sharing &amp; invites</Link>
          </Button>
        </CardContent>
      </Card>
